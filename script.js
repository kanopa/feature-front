...
thirdScroll
    ...
    .to(".trigger-photo1",2,{y: 80})
    .to(".wrapper-mars-pic", 4, {y: -180,z: -185, delay: 5})
	.to(".wrapper-mars-pic", 12,   {x: "-33.333%"})
    .to(".wrapper-mars-pic", 4, {y: 0, z: 0})
    .set(".trigger1", {className:"-=trigger11"})
    .to(".trigger-photo1",2,{y: 0},"-=2")
    .to(".trigger-photo2",4,{y: 80},"-=4")
    ...
    .to(".trigger-photo2",2,{y: 0},"-=2")
    .to(".trigger-photo3",4,{y: 80},"-=2")
